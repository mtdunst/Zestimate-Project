...
# Spatial join 
CLT_internal <- 
  st_join(CLT_internal,CLT_demo.sf) 
...
stargazer(as.data.frame(ss_boulderInternal), type="html", digits=1, title = "Descriptive Statistics for Charlotte Metro Area Homes [Internal] Variables")
```
