...
numericVars <- st_drop_geometry(CLT_internal) %>%
  dplyr::select(price, sqft, pricesqft, totbaths, bedrooms, numfirepla, heatedarea, yearbuilt, school_nn1, grocery_nn1, park_nn1, HH_inc, college_perc, FID) %>%
...
ggcorrplot(
  ...
  colors = c("lightskyblue", "white", "firebrick1"),
  type="lower",
  insig = "blank") +  
