...
Below is a table visualizing correlation between our variables. We can see the home price maintains a <span style="color:firebrick1;">postive</span> correlation with the following variables *(in order of strength)*:
